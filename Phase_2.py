    ...
    with tab2:
        ...
        with st.form("add_product_form"):
            ...
            with c1:
                ...
                _cat_selection = st.selectbox("Category", _existing_cats)
                _new_cat_input = st.text_input("New Category (overrides selection above if filled in)", placeholder="e.g., Shoes")
                new_cat = _new_cat_input.strip() if _new_cat_input.strip() else _cat_selection
            with c2:
